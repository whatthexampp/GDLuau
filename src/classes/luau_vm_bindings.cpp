...
void LuauVM::_bind_passthrough_methods() {
	...
	{
		// Status
		BIND_CONSTANT(LUA_OK);
		BIND_CONSTANT(LUA_YIELD);
		BIND_CONSTANT(LUA_BREAK);
		BIND_CONSTANT(LUA_ERRERR);
		BIND_CONSTANT(LUA_ERRMEM);
		BIND_CONSTANT(LUA_ERRRUN);
		BIND_CONSTANT(LUA_ERRSYNTAX);

		// Types
		BIND_CONSTANT(LUA_TNIL);
		BIND_CONSTANT(LUA_TBOOLEAN);
		BIND_CONSTANT(LUA_TLIGHTUSERDATA);
		BIND_CONSTANT(LUA_TNUMBER);
		BIND_CONSTANT(LUA_TVECTOR);
		BIND_CONSTANT(LUA_TSTRING);
		BIND_CONSTANT(LUA_TTABLE);
		BIND_CONSTANT(LUA_TFUNCTION);
		BIND_CONSTANT(LUA_TUSERDATA);
		BIND_CONSTANT(LUA_TTHREAD);
		// BIND_CONSTANT(LUA_TPROTO);
		// BIND_CONSTANT(LUA_TUPVAL);
		// BIND_CONSTANT(LUA_TDEADKEY);
		// BIND_CONSTANT(LUA_T_COUNT);
		...
		// GC Operations
		BIND_CONSTANT(LUA_GCSTOP);
		BIND_CONSTANT(LUA_GCRESTART);
		BIND_CONSTANT(LUA_GCCOLLECT);
		BIND_CONSTANT(LUA_GCCOUNT);
		BIND_CONSTANT(LUA_GCCOUNTB);
		BIND_CONSTANT(LUA_GCISRUNNING);
		BIND_CONSTANT(LUA_GCSTEP);
		BIND_CONSTANT(LUA_GCSETGOAL);
		BIND_CONSTANT(LUA_GCSETSTEPMUL);
		BIND_CONSTANT(LUA_GCSETSTEPSIZE);
